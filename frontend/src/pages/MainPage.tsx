...
const MainPage = () => (
    <div className="min-h-screen bg-blue-100 relative p-4 flex items-center justify-center h-full" style={{ minHeight: '100vh', backgroundImage: 'url(./images/mainpage.svg)', backgroundRepeat: 'no-repeat', backgroundPosition: 'right', backgroundSize: 'contain' }}>
