  ...
  <div className="flex h-screen bg-gray-100 text-gray-800">
    ...
    <aside className="w-64 bg-[#BBD7D9] p-4 flex flex-col justify-between">
      ...
      <div className="space-y-2">
        ...
        {/*/>*/}
        <a href="https://docs.google.com/document/d/1eOrF913VSX1qPp1aZ1DyNuyT0QKQm3Ib0wCnRA4NCqY/edit?usp=sharing"
           className="text-sm text-gray-700 flex items-center gap-1" target="_blank">
          <span role="img" aria-label="help">❓</span> Help
        </a>
        <a href="https://docs.google.com/document/d/12EdSq63tLxQTf5c17knVabinvZOW5SqKYZLI-x0s3DQ/edit?usp=sharing"
    ...
    {/*<div className="bg-white text-black dark:bg-gray-900 dark:text-white p-4 rounded-xl">*/}
    {/*    тема*/}
    {/*</div>*/}
